    ...
    <ul class="nav navbar-nav">
      <li class="nav-item dropdown nav-item active">
        ...
        <div class="dropdown-menu" id="sub" aria-labelledby="responsiveNavbarDropdown">
          ...
          <a id="sub" class="dropdown-item" href="listadoProd"><i class="btn btn-primary btn-sm  fa fa-list-ol"></i> Listado Clientes</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown nav-item active">
        ...
        <div class="dropdown-menu" id="sub" aria-labelledby="responsiveNavbarDropdown">
          <a id="sub" class="dropdown-item" href="restaurantes_view.php"><i class="btn btn-primary btn-sm  fa fa-user-plus"></i>Médicos</a>
          <a id="sub" class="dropdown-item" href="listadoProd"><i class="btn btn-primary btn-sm  fa fa-list-ol"></i>Categorias Médicos</a>
        </div>
      </li>
